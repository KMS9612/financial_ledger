...
export default function ResultBoxSmall(props: IPropsResultSmall) {
  return (
    <div className="w-96 flex flex-col justify-between rounded-lg shadow-lg p-2 border gap-6">
      <div className="text-2xl text-slate-700 font-bold">{props.title}</div>
      {/* 지출, 수익의 텍스트 색상 변환을 위한 로직 */}
      {props.title === "고정비용" ? (
        <div className="w-full overflow-auto flex flex-col justify-end items-start">
        ...
        <div className="w-full overflow-auto flex justify-end items-center gap-4">
          <span
